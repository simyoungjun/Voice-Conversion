...
class TextAudioSpeakerLoader(torch.utils.data.Dataset):
    ...
    def get_audio(self, filename):
        ...
        # utils.plot_spectrogram_to_numpy(mel_P.data.cpu().numpy(), name = 'mel_P')
        # utils.plot_spectrogram_to_numpy(spec.data.cpu().numpy(), name = 'spec')
        # utils.plot_spectrogram_to_numpy(mel_H.data.cpu().numpy(), name = 'mel_H')
        # utils.plot_spectrogram_to_numpy(mel_org.data.cpu().numpy(), name = 'mel_org')
