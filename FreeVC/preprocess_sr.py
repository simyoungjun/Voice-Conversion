...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="/home/sim/VoiceConversion/FreeVC/hifigan/config.json", help="path to config file")
    parser.add_argument("--in_dir", type=str, default="/shared/racoon_fast/sim/VCTK/preprocessed/vctk-22k", help="path to input dir")
    parser.add_argument("--wav_dir", type=str, default="/shared/racoon_fast/sim/VCTK/preprocessed/sr/wav", help="path to output wav dir")
    parser.add_argument("--ssl_dir", type=str, default="/shared/racoon_fast/sim/VCTK/preprocessed/sr/wavlm", help="path to output ssl dir")
    args = parser.parse_args()

    print("Loading WavLM for content...")
    checkpoint = torch.load('/home/sim/VoiceConversion/FreeVC/wavlm/WavLM-Large.pt')
