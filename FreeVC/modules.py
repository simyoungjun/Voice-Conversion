...
class VQEmbeddingEMA(nn.Module):
  ...
  def forward(self, x):
    ...
    embedding = self.embedding / (torch.norm(self.embedding, dim=1, keepdim=True) + 1e-4) # 얘는 왜 포워딩마다 하냐. 
    ...
    return x, quantized_, perplexity
    # return quantized_, commitment_loss, codebook_loss, perplexity
