...
from models_v6_2 import SynthesizerTrn
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hpfile", type=str, default="/home/sim/VoiceConversion/V6_2/freevc_v6_2.json", help="path to json config file")
    parser.add_argument("--ptfile", type=str, default="/shared/racoon_fast/sim/Checkpoints/logs/V6_2/G_98000.pth", help="path to pth file")
    ...
    parser.add_argument("--outdir", type=str, default="/home/sim/VoiceConversion/V6_2/output/LibriTTS_98", help="path to output dir")
