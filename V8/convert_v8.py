...
if __name__ == "__main__":
    ...
    parser.add_argument("--hpfile", type=str, default="/home/sim/VoiceConversion/V8/freevc_v8.json", help="path to json config file")
    ...
    parser.add_argument("--outdir", type=str, default="/home/sim/VoiceConversion/V8/output/VCTK_57", help="path to output dir")
