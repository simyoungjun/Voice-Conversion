...
from models_v5_5 import SynthesizerTrn
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hpfile", type=str, default="/home/sim/VoiceConversion/V5_5/freevc_v5_5.json", help="path to json config file")
    parser.add_argument("--ptfile", type=str, default="/shared/racoon_fast/sim/Checkpoints/logs/V5_5/G_216000.pth", help="path to pth file")
    ...
    parser.add_argument("--outdir", type=str, default="/home/sim/VoiceConversion/V5_5/output/VCTK_216", help="path to output dir")
