...
if __name__ == "__main__":
    ...
    parser.add_argument("--hpfile", type=str, default="/home/sim/VoiceConversion/V5_2/freevc_v5_2.json", help="path to json config file")
    parser.add_argument("--ptfile", type=str, default="/shared/racoon_fast/sim/CheckpointsV5/logs/V5_2/G_257000.pth", help="path to pth file")
    ...
    parser.add_argument("--outdir", type=str, default="/home/sim/VoiceConversion/V5_2/output/VCTK_257", help="path to output dir")
