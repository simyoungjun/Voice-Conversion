...
import utils
# 이부분 바뀜
from data_utils_v5_3 import (
  TextAudioSpeakerLoader,
  TextAudioSpeakerCollate,
  DistributedBucketSampler
)
from models_v5_2 import (
  SynthesizerTrn,
...
def main():
  ...
  parser.add_argument('-m', '--model', type=str, default="V5_3",
                      help='Model name')
  ...
  for batch_idx, items in enumerate(train_loader):
    ...
    with autocast(enabled=hps.train.fp16_run):
      ...
      with autocast(enabled=False):
        ...
        loss_gen_all = loss_gen + loss_fm + loss_mel + loss_kl + 2*loss_commitment + 2*loss_codebook+ loss_contrastive
