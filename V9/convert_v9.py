...
if __name__ == "__main__":
    ...
    model_name = 'V9_VQ1024_res_slice_cond'
    ...
    parser.add_argument("--ptfile", type=str, default="/shared/racoon_fast/sim/Checkpoints/logs/V9_VQ1024_res_slice_cond/G_80000.pth", help="path to pth file")
    ...
    parser.add_argument("--outdir", type=str, default=f"/shared/racoon_fast/sim/results/{model_name}/output/{meta_data}_80(1000)", help="path to output dir")
