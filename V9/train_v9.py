...
from models_v9_concat_2 import (
  SynthesizerTrn,
...
def main():
  ...
  parser.add_argument('-m', '--model', type=str, default="V9_VQ1024_res_slice_concat_2",
                      help='Model name')
...
def train_and_evaluate(rank, epoch, hps, nets, optims, schedulers, scaler, loaders, logger, writers):
  ...
  for batch_idx, items in enumerate(train_loader):
    ...
    with autocast(enabled=hps.train.fp16_run):
      # Generator -> y_hat
      # g: None, mel: None
      y_hat, ids_slice, (commit_loss, perplexity) = net_g(c, spec, g=g, mels=mel)
...
def evaluate(hps, nets, eval_loader, writer_eval):
    ...
    with torch.no_grad():
      ...
      y_hat, fig = generator.module.infer(c, g=g)
