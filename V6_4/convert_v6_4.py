...
from models_v6_4 import SynthesizerTrn
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hpfile", type=str, default="/home/sim/VoiceConversion/V6_4/freevc_v6_4.json", help="path to json config file")
    parser.add_argument("--ptfile", type=str, default="/shared/racoon_fast/sim/Checkpoints/logs/V6_4/G_62000.pth", help="path to pth file")
    ...
    parser.add_argument("--outdir", type=str, default="/home/sim/VoiceConversion/V6_4/output/VCTK_62", help="path to output dir")
    ...
    with torch.no_grad():
        for line in tqdm(zip(titles, srcs, tgts)):
            ...
            if hps.model.use_spk:
                ...
                audio = net_g.infer(spec_src, mels=mel)
