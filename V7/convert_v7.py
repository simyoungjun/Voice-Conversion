...
from V7.models_v7 import SynthesizerTrn
...
if __name__ == "__main__":
    ...
    parser.add_argument("--outdir", type=str, default="/home/sim/VoiceConversion/V6/output/VCTK_250", help="path to output dir")
